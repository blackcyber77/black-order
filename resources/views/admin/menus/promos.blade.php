        ...
        <div class="bg-white rounded-xl shadow p-6">
            ...
            <form action="{{ route('admin.menus.promos.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <select name="menu_item_id" required class="w-full px-3 py-2 border rounded-lg">
                ...
                <div>
                    ...
                    <select name="promo_type" required class="w-full px-3 py-2 border rounded-lg">
                ...
                <div>
                    ...
                    <input type="text" name="promo_title" value="{{ old('promo_title') }}" required maxlength="120" class="w-full px-3 py-2 border rounded-lg" placeholder="Contoh: Hemat Pagi 20%">
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                        <label class="block text-sm font-medium mb-1">Harga Coret (opsional)</label>
                        <input type="number" name="promo_original_price" min="0" step="500" value="{{ old('promo_original_price') }}" class="w-full px-3 py-2 border rounded-lg" placeholder="25000">
                    </div>
                    <div>
                        <label class="block text-sm font-medium mb-1">Urutan Atas</label>
                        <input type="number" name="promo_sort_order" min="0" value="{{ old('promo_sort_order', 0) }}" class="w-full px-3 py-2 border rounded-lg" placeholder="0">
                    </div>
                </div>

                <button type="submit" class="w-full py-3 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition font-semibold">
